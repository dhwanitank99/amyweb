...
class General extends \App\Entities\General implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\General' . "\0" . 'id', '' . "\0" . 'App\\Entities\\General' . "\0" . 'name', '' . "\0" . 'App\\Entities\\General' . "\0" . 'logo', '' . "\0" . 'App\\Entities\\General' . "\0" . 'phone', '' . "\0" . 'App\\Entities\\General' . "\0" . 'mobile', '' . "\0" . 'App\\Entities\\General' . "\0" . 'website', '' . "\0" . 'App\\Entities\\General' . "\0" . 'email', '' . "\0" . 'App\\Entities\\General' . "\0" . 'address', '' . "\0" . 'App\\Entities\\General' . "\0" . 'city', '' . "\0" . 'App\\Entities\\General' . "\0" . 'state', '' . "\0" . 'App\\Entities\\General' . "\0" . 'pinCode', '' . "\0" . 'App\\Entities\\General' . "\0" . 'details', '' . "\0" . 'App\\Entities\\General' . "\0" . 'status'];
        }
