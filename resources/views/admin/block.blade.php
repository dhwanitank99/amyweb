...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" id="pageForm" method="post" action="@if(isset($block)){{route('admin-update-block',['id'=>$block->getId()])}}@else{{route('admin-save-block')}}@endif" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" id="title" placeholder="" value="@if(isset($block)){{$block->getTitle()}}@endif">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" class="form-control">@if(isset($block)){{$block->getContent()}}@endif</textarea>
                                        </div>
                                    </div>
                                </div>
